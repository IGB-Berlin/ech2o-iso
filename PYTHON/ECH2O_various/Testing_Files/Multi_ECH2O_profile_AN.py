...
# --- Subroutine(s)
import ECH2O_Tools_profileNEW_AN as ECH2O_Tools
...
if Config.runECH2O == 1:
    ...
    if Config.scratch > 0:
        if Config.scratch == 1:
            Config.PATH_EXEC = '/scratch/users/r02ajn15/'+options.outdir
        if Config.scratch == 2:
            Config.PATH_EXEC = '/nobackup/users/r02ajn15/'+options.outdir
    else:
...
if Config.runECH2O == 1:
    ...
    Config.PATH_SPA_REF = os.path.abspath(os.path.join(Config.PATH_MAIN,'Spatial_'+Config.Resol))
