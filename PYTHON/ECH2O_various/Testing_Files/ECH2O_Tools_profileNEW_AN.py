...
def create_inputs(Opti, Paras, Site, Config, it):
    ...
    report(porosL1*0.95,Config.PATH_SPA+'/Soil_moisture_1.map')
    report(porosL2*0.9,Config.PATH_SPA+'/Soil_moisture_2.map')
    report(porosL3*0.9,Config.PATH_SPA+'/Soil_moisture_3.map')       
