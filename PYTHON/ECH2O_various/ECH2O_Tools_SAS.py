...
#                vegnew[iv][vegnew['name'].index(pname)] = str(Opti.x[Paras.ind[pname][iv]])
    ...
    report(porosL1*0,Config.PATH_SPA+'/d2H_groundwater.map')
    report(porosL1*0,Config.PATH_SPA+'/d2H_snowpack.map')
    report(porosL1*0,Config.PATH_SPA+'/d2H_soilL1.map')
    report(porosL1*0,Config.PATH_SPA+'/d2H_soilL2.map')
    report(porosL1*0,Config.PATH_SPA+'/d2H_soilL3.map')            
    report(porosL1*0,Config.PATH_SPA+'/d2H_surface.map')
