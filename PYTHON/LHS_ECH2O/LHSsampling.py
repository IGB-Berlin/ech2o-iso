...
def gen_paras(Opti, Config):
    ...
    # Monte-Carlo, uniform
    if(Config.sampling == 'MC'):
        
        #mat = lhsmdu.createRandomStandardUniformMatrix(2,10) # Monte Carlo Sampling
    ...
    if(Config.sampling == 'LHS'):
        ...
        mat = lhsmdu.sample(Opti.nvar,Opti.nsamptot) # Latin Hypercube Sampling of two variables, and 10 samples each.
