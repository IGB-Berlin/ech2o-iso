...
fitbeg = [datetime(2013,2,21),
          datetime(2013,2,21),datetime(2013,2,21),datetime(2013,2,21),datetime(2013,2,21),datetime(2015,2,25),
...
if switch == 0:
    ...
    for iobs in range(nobs):
        ...
        if obsnames[iobs]=='dD_DW1':
            print obs[obsnames[iobs]]
            print obst[obsnames[iobs]]
    ...
    for i in range(1,2):
        ...
        for iobs in range(nobs):
            ...
            if iobs==0:
                ...
                f_par = pardir+'/'+MCname+'_sampling_parameters.'+str(i)+'.txt'
            ...
            for j in range(1,3):#nj+1):
                ...
                if iobs ==0:
                    # -- Parameters 
                    tmp3 = [tmp_par[j-1][idx] for idx in range(npar)]
