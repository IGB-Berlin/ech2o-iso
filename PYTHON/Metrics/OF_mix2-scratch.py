...
Vars['SWC_Gley'] = {'sim':['SWC_Gley.L1_all.tab','SWC_Gley.L2_all.tab'],
                   'obs':'/SWC/VSM_Gley_daily.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PG',
                   'beg':datetime(2013,2,21),'end':datetime(2015,8,8)}
Vars['SWC_Podzol'] = {'sim':['SWC_Podzol.L1_all.tab','SWC_Podzol.L2_all.tab'],
                     'obs':'/SWC/VSM_Podzol_daily.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PP',
                     'beg':datetime(2013,2,21),'end':datetime(2015,8,8)}
#Vars['SWC_ForestA'] = {'sim':['SWC_SForest.L1_all.tab','SWC_SForest.L2_all.tab'],
#                      'obs':'/SWC/VSM_SForest_daily.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PP',
#                      'beg':datetime(2013,2,21),'end':datetime(2015,8,8)}
Vars['SWC_ForestB'] = {'sim':['SWC_NForest.L1_all.tab','SWC_NForest.L2_all.tab'],
                      'obs':'/SWC/VSM_NForest_daily.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PP',
                      'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}

Vars['T_ForestA'] = {'sim':['T_SForest_all.tab'],
                      'obs':'/ET/T_SForest_08072015-28092015.csv','obscol':[1],
                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
Vars['T_ForestB'] = {'sim':['T_NForest_all.tab'],
                      'obs':'/ET/T_NForest_01042016-22092016.csv','obscol':[1],
                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}

Vars['T_HeatherA'] = {'sim':['T_SHeather_all.tab'],
                      'obs':'/ET/ET_T_SHeather_31072015-04082016.csv','obscol':[1],
                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
Vars['T_HeatherB'] = {'sim':['T_NHeather_all.tab'],
                      'obs':'/ET/ET_T_NHeather_31072015-22092016.csv','obscol':[1],
                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
Vars['ET_HeatherA'] = {'sim':['ET_SHeather_all.tab'],
                      'obs':'/ET/ET_T_SHeather_31072015-04082016.csv','obscol':[2],
                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
Vars['ET_HeatherB'] = {'sim':['ET_NHeather_all.tab'],
                      'obs':'/ET/ET_T_NHeather_31072015-22092016.csv','obscol':[2],
                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
...
# Vars['dD_Stream'] = {'sim':['dD_Stream_all.tab'],
#                     'obs':'/Isotopes/dD_Stream.csv','obscol':[1],
#                     'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['dD_Peat'] = {'sim':['dD_Peat.L1_all.tab','dD_Peat.L2_all.tab'],
#                   'obs':'/Isotopes/dD_Peat.csv','obscol':[1,2],'obsdph':[0.1,0.3],'loc':'P',
#                   'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['dD_Gley'] = {'sim':['dD_Gley.L1_all.tab','dD_Gley.L2_all.tab'],
#                   'obs':'/Isotopes/dD_Gley.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PG',
#                   'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['dD_Podzol'] = {'sim':['dD_Podzol.L1_all.tab','dD_Podzol.L2_all.tab'],
#                      'obs':'/Isotopes/dD_Podzol.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PP',
#                     'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['dD_ForestA'] = {'sim':['dD_SForest.L1_all.tab','dD_SForest.L2_all.tab'],
#                      'obs':'/Isotopes/dD_ForestA.csv','obscol':[1,2,3,4,5,6,7,8],'loc':'PP',
#                      'obsdph':[0.025,0.075,0.1,0.125,0.175,0.3,0.25,0.5],
#                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['dD_ForestB'] = {'sim':['dD_NForest.L1_all.tab','dD_NForest.L2_all.tab'],
#                      'obs':'/Isotopes/dD_ForestB.csv','obscol':[1,2,3,4],'loc':'PP',
#                      'obsdph':[0.025,0.075,0.125,0.175],
#                      'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['dD_HeatherA'] = {'sim':['dD_SForest.L1_all.tab','dD_SForest.L2_all.tab'],
#                       'obs':'/Isotopes/dD_HeatherA.csv','obscol':[1,2,3,4],'loc':'PP',
#                       'obsdph':[0.025,0.075,0.125,0.175], # pixel = that of Forest A
#                       'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['dD_HeatherB'] = {'sim':['dD_NHeather.L1_all.tab','dD_NHeather.L2_all.tab'],
#                       'obs':'/Isotopes/dD_HeatherB.csv','obscol':[1,2,3,4],
#                       'obsdph':[0.025,0.075,0.125,0.175],'loc':'PP',
#                       'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}

# Vars['dD_ForestA.T'] = {'sim':['dD_SForest.T_all.tab'],
#                        'obs':'/Isotopes/dD_Xylem.csv','obscol':[1],
#                        'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['dD_ForestB.T'] = {'sim':['dD_NForest.T_all.tab'],
#                        'obs':'/Isotopes/dD_Xylem.csv','obscol':[2],
#                        'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['dD_HeatherA.T'] = {'sim':['dD_SForest.T_all.tab'], # pixel = that of Forest A
#                         'obs':'/Isotopes/dD_Xylem.csv','obscol':[3],
#                         'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['dD_HeatherB.T'] = {'sim':['dD_NHeather.T_all.tab'],
#                         'obs':'/Isotopes/dD_Xylem.csv','obscol':[4],
#                         'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}

# Vars['dD_DW1'] = {'sim':['dD_DW1_all.tab'],
#                      'obs':'/Isotopes/dD_deeperwells.csv','obscol':[1],
#                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['dD_DW2'] = {'sim':['dD_DW1_all.tab'], # uses same output as DW1 (same pixel at 100m)
#                      'obs':'/Isotopes/dD_deeperwells.csv','obscol':[2],
#                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['dD_DW3'] = {'sim':['dD_DW3_all.tab'],
#                      'obs':'/Isotopes/dD_deeperwells.csv','obscol':[3],
#                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['dD_DW4'] = {'sim':['dD_DW4_all.tab'],
#                      'obs':'/Isotopes/dD_deeperwells.csv','obscol':[4],
#                      'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
...
#                     'obs':'/Isotopes/d18O_Peat.csv','obscol':[1,2],'obsdph':[0.1,0.3],'loc':'P',
#                     'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['d18O_Gley'] = {'sim':['d18O_Gley.L1_all.tab','d18O_Gley.L2_all.tab'],
#                     'obs':'/Isotopes/d18O_Gley.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PG',
#                     'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['d18O_Podzol'] = {'sim':['d18O_Podzol.L1_all.tab','d18O_Podzol.L2_all.tab'],
#                       'obs':'/Isotopes/d18O_Podzol.csv','obscol':[1,2,3],'obsdph':[0.1,0.3,0.5],'loc':'PP',
#                       'beg':datetime(2013,2,21),'end':datetime(2015,2,20)}
# Vars['d18O_ForestA'] = {'sim':['d18O_SForest.L1_all.tab','d18O_SForest.L2_all.tab'],
#                        'obs':'/Isotopes/d18O_ForestA.csv','obscol':[1,2,3,4,5,6,7,8],
#                        'obsdph':[0.025,0.075,0.1,0.125,0.175,0.3,0.25,0.5],'loc':'PP',
#                        'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['d18O_ForestB'] = {'sim':['d18O_NForest.L1_all.tab','d18O_NForest.L2_all.tab'],
#                        'obs':'/Isotopes/d18O_ForestB.csv','obscol':[1,2,3,4],
#                        'obsdph':[0.025,0.075,0.125,0.175],'loc':'PP',
#                        'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['d18O_HeatherA'] = {'sim':['d18O_SForest.L1_all.tab','d18O_SForest.L2_all.tab'], 
#                         'obs':'/Isotopes/d18O_HeatherA.csv','obscol':[1,2,3,4],'loc':'PP',
#                         'obsdph':[0.025,0.075,0.125,0.175], # pixel = that of Forest A
#                         'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['d18O_HeatherB'] = {'sim':['d18O_NHeather.L1_all.tab','d18O_NHeather.L2_all.tab'],
#                         'obs':'/Isotopes/d18O_HeatherB.csv','obscol':[1,2,3,4],
#                         'obsdph':[0.025,0.075,0.125,0.175],'loc':'PP',
#                         'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}

# Vars['d18O_ForestA.T'] = {'sim':['d18O_SForest.T_all.tab'],
#                        'obs':'/Isotopes/d18O_Xylem.csv','obscol':[1],
#                        'beg':datetime(2013,2,21),'end':datetime(2016,8,8)}
# Vars['d18O_ForestB.T'] = {'sim':['d18O_NForest.T_all.tab'],
#                        'obs':'/Isotopes/d18O_Xylem.csv','obscol':[2],
#                        'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['d18O_HeatherA.T'] = {'sim':['d18O_SForest.T_all.tab'], # pixel = that of Forest A
#                           'obs':'/Isotopes/d18O_Xylem.csv','obscol':[3],
#                         'beg':datetime(2015,2,25),'end':datetime(2016,8,8)}
# Vars['d18O_HeatherB.T'] = {'sim':['d18O_NHeather.T_all.tab'],
